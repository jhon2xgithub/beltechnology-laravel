...
class KlantenController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->passes())
        {
            ...
            $klanten->company_number                = $request->input('company_number');
    ...
    public function show($id)
    {
        ...
        $related_orders = Orders::leftJoin('klantens', 'klantens.id', 'orders.client_id')->where('orders.client_id', $id)->select('client_id', 'order_reference_number', 'order_clients', 'order_supplier', 'order_status', 'orders.updated_at')
        ...
        {
            $leveranciers = DB::table('leveranciers')->where('leveranciers.supplier_name', $related_orders[0]->order_supplier)
                ->get();
    ...
    public function destroy($id)
    {
        ...
        return redirect()
            ->back()
            ->with('message', 'client id: ' . $id . ' has been deleted');
    }
