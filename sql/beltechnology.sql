...
(473, 18676, 'PvB/18.676/1801', 'Online Store', 'GOODS RECEIVED', 'John', 'Magento 2 extensions', '59.00', 1, '', '%?', 'storage/pdf-quotation/client/received quotation from client/5a93a451067e3Delivery Note (1).pdf', 1, 'storage/supplier/quoterequest/5a93a7d31cb87Request for quotationn from supplier(s) (3).pdf', 'storage/supplier/quotesupreceived/5a93c101098c0adaptations emeritis website 2018-02-25.pdf', 'storage/client/generate invoice/5a93c4cc163fbInvoice (2).pdf', 'storage/client/quoteacceptance/5a93c256b007cadaptations emeritis website 2018-02-25.pdf', 'storage/supplier/uploadconfirmationsupplierdoc/5a93c2c90cbdbQuotation for client (3).pdf', '5a93c4b35d5e1Request for quotationn from supplier(s) (4).pdf', 'storage/supplier/sendconfirmationtosupplier/5a93c28c5af8fOrder confirmation to supplier (2).pdf', 'storage/client/generateconfirmationtoclientdoc/5a93c2ea2b127Order confirmation to supplier (2).pdf', 'GOODS RECEIVED', '', '', 'GOODS SENT', '2018-02-25 22:08:17', '2018-02-26 00:39:35');
