        ...
        <div class="row">
                ...
                <table class="table table-bordered_ table-striped table-responsive_">
                    <tbody>
                        <tr>
                            ...
                            <td>{{$leveranciers->id}}</td>
                        </tr>
                        <tr>
                            <th class="text-nowrap" scope="row">Supplier Name</th>
                            <td>{{$leveranciers->supplier_name}}</td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-nowrap" scope="row">
                                <div class="row">
                                    ...
                                    <!-- company email -->
                                    <div class="col-md-3 text-right">Supplier email:</div>
                                    <div class="col-md-9">
                                        <a href="mailto:#">{{$leveranciers->supplier_email}}</a>
                                    </div>
                                </div>
                        ...
                        <tr>
                            ...
                            <td>{{$leveranciers->supplier_email}}</td>
                        </tr>
                        <tr>
            ...
            <div class="col-md-6">
                ...
                <?php
	    	   				...
	    	   				// print_r($leveranciers->supplier_person_last_name);
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td><span class="inline-edit"><a href='{{url("/kread/{$klantens[0]->id}")}}'>{{$order->order_clients}}</a></span></td>
