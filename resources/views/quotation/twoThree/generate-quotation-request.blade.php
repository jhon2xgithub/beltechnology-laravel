...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            <br/>
            <br/>
            <span style="color:#fefefe;">resources\views\quotation\twoThree\generate-quotation-request.blade.php</span>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane active" id="profile" role="tabpanel">
                ...
                <div id="en">  
                  <form method="post" action="{{url('vendor/unisharp/laravel-ckeditor/process.php')}}">
                    ...
                    <input type="hidden" name="filename" value="Request for quotationn from supplier(s)" />
                    ...
                    <textarea cols="80" class="ckeditor" name="editor" id="editor" rows="10">
                      ...
                      <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong><u>T.a.v. {{$supplier[0]->contact_first_name}} {{$supplier[0]->contact_lastname}}</u></strong><br />
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$supplier[0]->supplier_street}},&nbsp; {{$supplier[0]->supplier_number}}<br />
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$supplier[0]->supplier_zip}}&nbsp; {{$supplier[0]->supplier_city}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</p>
                      ...
                      <ul>
                        ...
                        @foreach(explode(',',$order[0]->order_product) as $key => $product)
                          ...
                          <li>Afm./Gewicht : &nbsp;{{ $order_dimensionweight[$key] }}&nbsp;&nbsp;&nbsp;&nbsp; voor de <strong>Stuksprijs van : </strong>&nbsp;<strong><u>{{ $order_price[$key] }}&euro;/st.</u></strong></li>
                        @endforeach
                      </ul>
              ...
              <div class="tab-pane" id="home" role="tabpanel">
                  ...
                  <form name=f1 id="post-generate-quotation-request-form" method="post" action="{{url('/post-generate-quotation-request-form')}}" role="form" enctype="multipart/form-data">
                      {{ csrf_field() }}
                      ...
                      <div class="row">
                          ...
                          <div class="form-group col-sm-12">
                              ...
                              <!-- <input type="email" placeholder="Email" class="form-control" id="email" name="email"  value="{{ $data['supplier_email'] }}" placeholder="Email" > -->
