...
<head>
    ...
    .section-divider {
     ...
     .section-divider span, .admin-form .tab-content .section-divider span, .admin-form.panel .section-divider span, .admin-form.tab-content .section-divider span {
...
<body class="hidden">
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
        <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">Bel.Technology
          <!-- <img class="navbar-brand" src="{{URL::asset('/images/beltech-logo.png')}}" alt="Bel.Tec"> -->
      </a>
...
$(function() {
    ...
    $(".openModalLink").click(function() {
        ...
        if (target.substr(1) == 'quote-received') {
            ...
            var ostore_url = '{{ url("oquotedreceived") }}/' + id;
        }
        ...
        if (target.substr(1) == 'quote-request') {
            ...
            $('[name="row_num"]').val(row_num);
            $('[name="column_index"]').val(column_num);
            var ostore_url = '{{ url("quote-request") }}/' + id;
        }

        if (target.substr(1) == 'quote-sup-received') {
            $('[name="row_num"]').val(row_num);
            $('[name="column_index"]').val(column_num);
            var ostore_url = '{{ url("quote-sup-received") }}/' + id;
        ...
        if (target.substr(1) == 'order-details') {
            $('[name="row_num"]').val(row_num);
            $('[name="column_index"]').val(column_num);
            var ostore_url = '{{ url("order-details") }}/' + id;
        }
        ...
        if (target.substr(1) == 'quote-sent') {
            $('[name="row_num"]').val(row_num);
            $('[name="column_index"]').val(column_num);
            var ostore_url = '{{ url("quote-sent") }}/' + id;
        }

        if (target.substr(1) == 'quote-acceptance') {
            $('[name="row_num"]').val(row_num);
            $('[name="column_index"]').val(column_num);
            var ostore_url = '{{ url("quote-acceptance") }}/' + id;
        }
        ...
        if (target.substr(1) == 'send-confirmation-to-supplier') {
            $('[name="row_num"]').val(row_num);
            $('[name="column_index"]').val(column_num);
            var ostore_url = '{{ url("send-confirmation-to-supplier") }}/' + id;
        }
        if (target.substr(1) == 'upload-confirmation-supplier-doc') {
            $('[name="row_num"]').val(row_num);
            $('[name="column_index"]').val(column_num);
            var ostore_url = '{{ url("upload-confirmation-to-supplier-doc") }}/' + id;
        }
        if (target.substr(1) == 'generate-confirmation-to-client-doc') {
            $('[name="row_num"]').val(row_num);
            $('[name="column_index"]').val(column_num);
            var ostore_url = '{{ url("generate-confirmation-to-client-doc") }}/' + id;
        }
        ...
        if (target.substr(1) == 'goods-received') {
            $('[name="row_num"]').val(row_num);
            $('[name="column_index"]').val(column_num);
            var ostore_url = '{{ url("goods-recieved") }}/' + id;
            // var ostore_url = '{{ url("ogoodRecievedSent") }}/'+id;
        }
        if (target.substr(1) == 'goods-sent-sup') {
            $('[name="row_num"]').val(row_num);
            $('[name="column_index"]').val(column_num);
            var ostore_url = '{{ url("goods-sent-sup") }}/' + id;
            // var ostore_url = '{{ url("ogoodRecievedSent") }}/'+id;
        }
        if (target.substr(1) == 'good-received-sup') {
            $('[name="row_num"]').val(row_num);
            $('[name="column_index"]').val(column_num);
            var ostore_url = '{{ url("good-received-sup") }}/' + id;
            // var ostore_url = '{{ url("ogoodRecievedSent") }}/'+id;
        }
        if (target.substr(1) == 'goods-sent') {
            $('[name="row_num"]').val(row_num);
            $('[name="column_index"]').val(column_num);
            var ostore_url = '{{ url("upload-supplier-invoice") }}/' + id;
            // var ostore_url = '{{ url("ogoodRecievedSent") }}/'+id;
        }
        ...
        if (target.substr(1) == 'invoice-sent') {
            ...
            $('[name="row_num"]').val(row_num);
            $('[name="column_index"]').val(column_num);
            // var ostore_url = '{{ url("sent-delivery-document-to-supplier") }}/'+id;
            // var ostore_url = '{{ url("ogoodRecievedSent") }}/'+id;
        }
        ...
        $.each(data, function(i, item) {
            ...
            if (item.id == id) {
                ...
                if (item.order_status == 'GENERATE CONFIRMATION TO CLIENT DOC') {
                ...
                if (item.order_status == 'GOOD RECEIVED SUP') {
                    // alert(item.order_exclusivity_status);
                    if(item.order_exclusivity_status == 1){
                        // $('.' + target.substr(1)).find('form').attr('action', 'asfasfasfasf')
                        $('.' + target.substr(1)).find('#has_exclusivity').val(item.order_exclusivity_status);
                ...
                var URL = '{{url("/generate-quotation-request-form")}}/' + id + '/' + supplier.val() + '/' + row_num + '/' + column_num;
                // $('[name="row_num"]').val(row_num);
                // $('[name="column_index"]').val(column_num);
                ...
                //
                var URL = '{{url("/generate-quotation-request")}}/' + id + '/' + item.client_id;
                ...
                //gsc
                var URL = '{{url("/send-confirmation-to-supplier")}}/' + id + '/' + supplier.val();
                // alert(URL);
                ...
                // for gcc
                var URL = '{{url("/generate-client-confirmation")}}/' + id + '/' + item.client_id;
                ...
                var URL = '{{url("/generate-delivery-document")}}/' + id;
                ...
                var URL = '{{url("/generate-invoice")}}/' + id;
