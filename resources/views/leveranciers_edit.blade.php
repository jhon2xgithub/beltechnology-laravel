...
@section('content')
		<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
		    ...
		    <form class="needs-validation" novalidate="" method="post" action="{{ url('/lupdate', [$leveranciers->id]) }}" id="lupdate-form_">
		        {{ csrf_field() }}
		        <div class="container col-md-12">
		            <div class="row">
		                ...
		                <div class="col-md-6">
		                    ...
		                    <hr class="mb-4">
		                    <button class="btn btn-success btn-sm" type="submit">Update Supplier</button>
